...
{
  for(long long int img_id = 14037152817; img_id < 14037152838; )
  {
    // load image
    ...
    if(count%2 == 0)
    {
      ss << svo::test_utils::getDatasetDir()<<"/"
       << std::setw( 11 ) << img_id << "62142976.png";
    }
    else
    {
      ss << svo::test_utils::getDatasetDir()<<"/"
       << std::setw( 11 ) << img_id << "12143104.png";
       ++img_id;
    }
    count++;
    if(img_id == 14037152817)
    ...
    // process frame
    vo_->addImage(img, 0.000000000001*img_id);
